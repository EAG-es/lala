...
public class abrir_archivos extends A_ejecutores {
    ...
    public boolean ejecutar(Map<String, Object> objects_mapa, String[] error) {
        ...
        try {
            ...
            if (ret) {
                ruta_seleccionada = (String) objects_mapa.get(procesar_abrir_archivos.k_mapa_archivo_seleccionado);
            ...
            if (ret) {
                ...
                objects_mapa.put(procesar_abrir_archivos.k_mapa_archivo_seleccionado, ruta_seleccionada);
            ...
            error[0] = "Error en ejecutar.abrir_archivos";
            ret = false;
        }
        return ret;
    }
