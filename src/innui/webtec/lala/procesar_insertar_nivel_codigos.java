...
public class procesar_insertar_nivel_codigos extends A_ejecutores {
    ...
    public static String k_mapa_procesar_insertar_nivel_codigos_errores = "innui_webtec_lala_procesar_insertar_nivel_codigos_errores";
    ...
    public boolean ejecutar(Map<String, Object> objects_mapa, String[] error) {
        ...
        try {
            ...
            if (boton == null) {
                error[0] = "";
                objects_mapa.remove(k_mapa_procesar_insertar_nivel_codigos_errores);
                ...
                if (ret == false) {
                    ...
                    objects_mapa.put(k_mapa_procesar_insertar_nivel_codigos_errores, innui_webtec_gui_autoformularios_errores);
                } else {
                    ...
                    if (ret == false) {
                        ...
                        objects_mapa.put(k_mapa_procesar_insertar_nivel_codigos, error[0]);
                    }
                }
            } 
        } catch (Exception e) {
