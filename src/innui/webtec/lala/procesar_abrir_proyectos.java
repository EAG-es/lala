...
public class procesar_abrir_proyectos extends A_ejecutores {
    public static String k_mapa_procesar_abrir_proyectos_errores = "innui_webtec_lala_procesar_abrir_proyectos_errores"; //NOI18N
    ...
    public boolean ejecutar(Map<String, Object> objects_mapa, String[] error) {
        ...
        try {
            ...
            objects_mapa.remove(k_mapa_procesar_abrir_proyectos_errores);
            if (ret == false || boton_enviar_pulsado == null) {
                ...
                objects_mapa.put(k_mapa_procesar_abrir_proyectos_errores, innui_webtec_gui_autoformularios_errores);
            } else {
